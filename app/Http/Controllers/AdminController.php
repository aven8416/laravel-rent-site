...
class AdminController extends Controller
{
    ...
    public function view_order_details($id) {
        ...
        $ProductsDetails =  DB::table('order_products')->rightJoin('products', 'products.id', '=', 'order_products.products_id')->rightJoin('orders', 'orders.id', '=', 'order_products.orders_id')->rightJoin('addresses', 'addresses.user_id', '=', 'orders.user_id')->where('orders_id', '=', $id)->get();
